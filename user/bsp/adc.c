#include "adc.h"
#include "usart1.h"
uint16_t adcValue[20] = {0};
ADC_VALUE_Def adclight={0};
ADC_VALUE_Def adcMq2={0};
...
void Get_Adc()
{
	...
	{
		adcAvg[0] +=adcValue[i]/10.0;
		adcAvg[1] +=adcValue[i+1]/10.0;
	}
	adclight.adc =adcValue[0];
	adclight.v = adcValue[0]*3.3/4095;
	adcMq2.adc = adcValue[1];
	adcMq2.v = adcValue[1]*0.4/4096*10;
}
